    ...
    <div className="flex justify-center items-center h-screen bg-gray-200">
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-8 ">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="js">IIIT Delhi</option>
              <option value="react">IIT Delhi</option>
              <option value="api">DTU</option>
              <option value="backend">NSUT</option>
            </select>
        ...
        <div className="flex justify-end mt-4">
          <Link
            to="/search1"
            className="bg-green-700 hover:bg-green-500 text-white px-4 py-2 rounded transition-colors duration-300"
          >
            Next
          </Link>
        </div>
